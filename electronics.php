...
$audioProducts = getProductsByCategory($conn, 'audio');
$computerProducts = getProductsByCategory($conn, 'computers');
$gamingProducts = getProductsByCategory($conn, 'gaming');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Shoppie Electronics</title>
    ...
    <main>
        <div class="category-row">
            ...
            <div class="product-slider">
                <?php foreach ($audioProducts as $product) : ?>
